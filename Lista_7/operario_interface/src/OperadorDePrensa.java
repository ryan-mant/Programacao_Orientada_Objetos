public class OperadorDePrensa implements Operario{
    ...
    public OperadorDePrensa(String nome, String areaDeServico, int intervalo){
        this.nome = nome;
        this.areaDeServico = areaDeServico;
        this.intervalo = intervalo;
    }
    ...
    public void trabalhar() {
        System.out.println("O " + getNome() + " da area de: " + getAreaDeServico() + ". Começou seu expediente: prensa*, prensa*, prensa*. E foi almoçar por "
